                    ...
                    <CardContent className="p-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Button asChild variant="outline">
                                <a href="/empty.pdf" download="seat-alternatives.pdf">1- Seat Alternatives</a>
                            </Button>
                            <Button asChild variant="outline">
                                <a href="/empty.pdf" download="dimensions.pdf">2- Show Dimensions</a>
                            </Button>
                        </div>
                    </CardContent>
                </Card>
                        ...
                        {product.details?.dimensions && product.details.dimensions.length > 0 ? (
                            <div className="overflow-x-auto">
                                <Table>
                                    ...
                                    <TableBody>
                                        {product.details.dimensions.map((row: any, index: number) => (
                                        <TableRow key={index}>
